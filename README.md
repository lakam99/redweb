...
Run `npm run verify:browser:coverage` for native Chromium tests of the generated DOM-morph module, enforcing 100% statement/branch/function/line coverage and testing identical behavior without instrumentation. It also verifies select preservation through a real live page's HTTP/WebSocket actions. Other generated browser modules and whole-application coverage remain separate work; this is not a complete browser-coverage claim.
