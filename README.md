...
Recovery workers also retain non-Error failures and clean up rejected IPC requests immediately; empty error replies cannot masquerade as success. [Real-process regressions and fresh server recovery evidence](docs/SPLIT_RECOVERY_ERROR_HANDLING.md) distinguish these corrections from the remaining runner coverage work.
