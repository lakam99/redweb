...
const harnessPaths = [
    ...
    ...['verify-action-feedback', 'verify-dashboard-browser', 'verify-starter', 'VerificationWorkspace',
        'verificationError', 'finishVerificationSummary', 'BrowserCoverage', 'BrowserPages', 'assertCoverageFile', 'browserCommands', 'verify-runtime-browser', 'verify-refresh-coverage',
